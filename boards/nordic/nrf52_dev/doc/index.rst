...
`nRF52 DEV website`_. `nRF52832 Product Specification`_
...
nRF52 DEV has two external oscillators. The frequency of
...
See `nRF52 DEV website`_ and `nRF52832 Product Specification`_
...
Replace :code:`<tty_device>` with the port where the board nRF52 DEV
...
Testing the LEDs and buttons in the nRF52 DEV
********************************************
...
:zephyr_file:`boards/nordic/nrf52_dev/nrf52_dev_nrf52832.dts`.

.. _nrf52_dev_nrf52805:

nRF52805 emulation on nRF52 DEV
******************************

The ``nrf52_dev/nrf52805`` board is a modified version of the :zephyr:board:`nrf52_dev`
...
nRF52810 emulation on nRF52 DEV
******************************

The ``nrf52_dev/nrf52810`` board variant is a modified version of the :zephyr:board:`nrf52_dev`
...
.. _nRF52 DEV website: https://www.nordicsemi.com/Software-and-Tools/Development-Kits/nRF52-DEV
